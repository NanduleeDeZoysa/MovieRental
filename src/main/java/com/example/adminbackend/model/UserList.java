...
public class UserList {
    ...
    public void insertFirst(UserNode node) {
        UserNode newNode=new UserNode(node.getName(),node.getEmail(),node.getNumber(),node.getPassword(),node.UserID,node.repeatPassword);
    ...
    public void add(UserNode current)
    {
